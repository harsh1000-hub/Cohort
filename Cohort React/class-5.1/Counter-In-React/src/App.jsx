...
function App() {
  ...
  return (
    ...
    {/* Inside curly bracket we pass {count} this count is basically the count value that is in local state*/}
     <Button count={count} setCount={setCount}></Button> {/* here passing setCount function as props in below button Component and same for count*/}
    </div>
  )
}
function Button(props){  // props is way to pass data from parent component to child component and vice-versa
